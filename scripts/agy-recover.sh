...
echo -e "✓ Ownership dan permission berhasil dinormalisasi."
...
echo -e "✓ Berhasil membersihkan $REMOVED_LOCKS presence lock file."
...
if command -v warp-cli >/dev/null 2>&1; then
  ...
  echo -e "✓ Cloudflare WARP berhasil di-refresh."
fi
...
echo -e "\n======================================================"
echo -e "✓ RECOVERY SELESAI. Anda dapat langsung menjalankan 'agy'."
echo -e "======================================================"
