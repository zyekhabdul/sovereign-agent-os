...
if [ ! -f "$HOME/.gemini/config/mcp_config.json" ]; then
  ...
  cp "$REPO_ROOT/templates/mcp/mcp_config.template.json" "$HOME/.gemini/config/mcp_config.json" 2>/dev/null || true
fi
...
if [ ! -f "$HOME/.gemini/config/mcp_config_extended.json" ]; then
  ...
  cp "$REPO_ROOT/templates/mcp/mcp_config_extended.template.json" "$HOME/.gemini/config/mcp_config_extended.json" 2>/dev/null || true
fi
