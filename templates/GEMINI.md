...
### Core Directives Summary (16 Modular Binding Rules)
...
- **Environment Topology**: Dual-mode laptop vs VPS decoupling & sovereign host discipline (`~/.gemini/config/rules/environment-topology.md`)
